...
interface Notification {
  id: string;
  type: "MATCH_NEW" | "SELLER_UNLOCKED" | "PROFILE_VIEW" | "SYSTEM";
  title: string;
  message: string;
  read: boolean;
  createdAt: string;
...
const colorMap = {
  ...
  SELLER_UNLOCKED: "text-brand-secondary bg-brand-secondary/10",
          ...
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-brand-gray text-center">
              {filter === "unread"
                ...
                : "Vous recevrez des notifications lorsque des vendeurs s'intéresseront à votre profil."}
            </p>
          </CardContent>
        </Card>
      ) : (
